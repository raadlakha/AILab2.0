...
![NASK — Complete Canvas Topology: Parallel PI + Skill → Retriever → Prompt](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-30.png)
...
![NASK — General Info: ResolutionFinderUsingInternalData](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-1.png)
...
![NASK — Security Controls: User Access and Role Restrictions](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-2.png)
...
![NASK — Skill Input 1: Record from Incident Extend table](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-3.png)
...
![NASK — Skill Input 2: Record from Incident Extend table String](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-10.png)
...
![NASK — Tool Type: Predictive Intelligence](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-4.png)
...
![NASK — PI Tool: General Info](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-5.png)
...
![NASK — PI Tool: Tool Inputs](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-6.png)
...
![NASK — PI Tool: Tool Outputs](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-7.png)

#### Step 4d — Tool Conditions

Type: **None (Always run)**

![NASK — PI Tool: Tool Conditions](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-8.png)

#### Step 4e — Summary

Verify and click **Save changes**.

![NASK — PI Tool: Summary](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-9.png)

> After saving, the canvas shows the FindSimilarIncidents node added below Start:

![NASK — Canvas After PI Tool Added](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-11.png)
...
![NASK — Add Node Dialog: Tool Node](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-12.png)

Select **Skill**, check **Add as parallel node** → **Configure tool**.

![NASK — Add Skill as Tool: Parallel Node Checked](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-13.png)
...
![NASK — Skill Tool: General Info](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-14.png)
...
![NASK — Skill Tool: Tool Inputs](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-15.png)
...
![NASK — Skill Tool: Tool Outputs](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-16.png)

#### Step 5d — Tool Conditions

Type: **None (Always run)**

![NASK — Skill Tool: Tool Conditions](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-17.png)

#### Step 5e — Summary

Verify **Add as a parallel node: Yes** → click **Add tool**.

![NASK — Skill Tool: Summary](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-18.png)
...
![NASK — Canvas: Two Parallel Tools](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-19.png)
...
![NASK — Add Node Dialog: Tool Node for Retriever](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-20.png)

The tool type picker appears. Select **Retriever** → **Configure tool**.

![NASK — Tool Type: Retriever](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-21.png)
...
![NASK — Retriever Tool: General Info](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-22.png)
...
![NASK — Retriever Tool: Tool Inputs — Core Search Configuration](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-23.png)
...
![NASK — Retriever Tool: Advanced Settings — Chunking and Threshold](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-24.png)
...
![NASK — Retriever Tool: Advanced Settings — Chunking and Re-Ranking](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-25.png)
...
![NASK — Retriever Tool: Tool Outputs](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-26.png)
...
![NASK — Retriever Tool: Tool Conditions](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-27.png)
...
![NASK — Retriever Tool: Summary (Top)](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-28.png)

![NASK — Retriever Tool: Summary (Bottom)](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-29.png)
...
![NASK — Final Canvas: Complete Skill Flow](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-30.png)
...
![Now Assist Admin — Skills: ResolutionFinderUsingInternalData](../.gitbook/assets/NASKResolutionFinderUsingInternalData2-32.png)
