...
![User Menu — Impersonate user option](../.gitbook/assets/Agentic-WF-testing-1.png)

3. In the **Impersonate user** dialog, select **Amelia Bryant** (`amelia.bryant`)
4. Click **Impersonate user** to confirm

![Impersonate user dialog — Amelia Bryant selected](../.gitbook/assets/Agentic-WF-testing-2.png)
...
![Left navigation — Incidents > Unassigned](../.gitbook/assets/Agentic-WF-testing-4.png)

![Service Operations Workspace — My Incidents](../.gitbook/assets/Agentic-WF-testing-3.png)
...
![Incidents — Unassigned list with INCE0012001 and INCE0012002](../.gitbook/assets/Agentic-WF-testing-6.png)
...
![INCE0012001 — Assigning to Amelia Bryant](../.gitbook/assets/Agentic-WF-testing-5.png)
...
![Now Assist panel — Active: INCE0012001 - Veritas Resolution Agentic Workflow](../.gitbook/assets/Agentic-WF-testing-9.png)

13. Click on the active chat to open it. The Now Assist panel shows the workflow executing in real time:

![Now Assist — Resolution Pathfinder agent starting, tools firing](../.gitbook/assets/Agentic-WF-testing-10.png)
...
![Now Assist — Resolution Plan for INCE0012001 with numbered steps](../.gitbook/assets/Agentic-WF-testing-11.png)
...
15. Scroll down to review the complete Resolution Plan. It should include:
    ...
    * A confirmation prompt: _"Would you like to update anything within this Resolution Plan before it is finalized and written to the incident record?"_

![Now Assist — Full Resolution Plan with steps, source citations, and confirmation](../.gitbook/assets/Agentic-WF-testing-12.png)
...
![Now Assist — ObsAgent Observability Validation results](../.gitbook/assets/Agentic-WF-testing-13.png)
...
![Incidents — Unassigned list](../.gitbook/assets/Agentic-WF-testing-15.png)

20. Click on **INCE0012002** to open the Incident record
21. In the **Assigned to** field, search for and select **Amelia Bryant**

![INCE0012002 — Assigning to Amelia Bryant](../.gitbook/assets/Agentic-WF-testing-16.png)
...
![Now Assist panel — Active: INCE0012002 - Veritas Resolution Agentic Workflow](../.gitbook/assets/Agentic-WF-testing-18.png)
...
![Now Assist — Resolution Pathfinder agent executing for INCE0012002](../.gitbook/assets/Agentic-WF-testing-19.png)
...
![Now Assist — No internal resolution found, web search prompt](../.gitbook/assets/Agentic-WF-testing-20.png)
...
![Now Assist — Web search query approval (first confirmation)](../.gitbook/assets/Agentic-WF-testing-21.png)
...
![Now Assist — Web search query displayed, final confirmation](../.gitbook/assets/Agentic-WF-testing-22.png)
...
![Now Assist — Resolution Plan from web search: issue summary and common causes](../.gitbook/assets/Agentic-WF-testing-23.png)

31. Scroll down to review the complete plan — numbered troubleshooting steps and source links:

![Now Assist — Full troubleshooting steps and source references](../.gitbook/assets/Agentic-WF-testing-24.png)
