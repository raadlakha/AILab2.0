...
![Define the specialty — agent name and description](../.gitbook/assets/L1-Agent.png)
...
![Add tools and information — tool list](../.gitbook/assets/L1-Agent2.png)
...
![Add a Knowledge graph dialog](../.gitbook/assets/L1-agent-tool-kg1.png)
...
![Add file upload dialog — fields](../.gitbook/assets/L1-agent-tool4-file-upload.png)

![Add file upload dialog — attachment](../.gitbook/assets/L1-agent-tool4-file-upload2.png)
...
![Add tool dropdown — Conversational topic highlighted](../.gitbook/assets/L1-Agent-Tool1.png)

The **Add a conversational topic** dialog opens:

![Add a conversational topic dialog](../.gitbook/assets/L1-agent-tool-conv-topic.png)
...
![Add tool dropdown — Subflow highlighted](../.gitbook/assets/L1-agent-tool2.png)

The **Add a subflow** dialog opens:

![Add a subflow — subflow selection and inputs](../.gitbook/assets/L1-agent-tool2-subflow.png)

![Add a subflow — tool name and description](../.gitbook/assets/L1-agent-tool2-subflow2.png)
...
![Define user access — role assignment](../.gitbook/assets/L1-agent-user-access.png)
...
![Define data access — user identity](../.gitbook/assets/L1-agent-data-access.png)
...
![Add triggers — trigger configuration](../.gitbook/assets/L1-agent-trigger.png)
...
![Select channels and status](../.gitbook/assets/L1-agent-channel-status.png)
...
>
> The yellow informational banner — _"this AI agent is designed to be part of an agentic workflow that users can discover in the Now Assist panel"_ — does not require action for this lab.
...
4. Reply _"resolved"_ → conversation ends, no Incident created (**deflection path confirmed**)
5. Re-run. Reply _"not resolved"_ → **Tool 3 check** — in-chat image upload prompt appears
