...
1. Open the file at [`../NASKprompts/CreateOptimalSearchQuery-Prompt`](https://github.com/raadlakha/AILab2.0/blob/main/NASKprompts/CreateOptimalSearchQuery-Prompt) in the lab repository
